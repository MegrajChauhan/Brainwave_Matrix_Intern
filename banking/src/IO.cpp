...
void bank::print(std::string msg)
{
    console()->append_to_body_last_line(msg);
}

void bank::println(std::string msg)
{
...
void bank::left_arrow()
{
    // scroll up
    console()->viewport_shift(true, 1);
}

void bank::right_arrow()
{
    // scroll down
